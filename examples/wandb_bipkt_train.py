...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", type=str, default="lg")
    parser.add_argument("--model_name", type=str, default="bipkt")
    ...
    parser.add_argument("--loss1", type=float, default=1)
