...
def read_data_from_csv(read_file, write_file):
    ...
    df = df.dropna(subset=["submit_useruid", "problem_pid","kc","status_true","rs","submit_time_cost","problem_difficulty","score_true","submit_memery_cost"])
    ...
    ui_df = df.groupby('submit_useruid', sort=True)
    ...
    for ui in ui_df:
        ...
        score = curdf['score_true'].astype(int).astype(str).tolist()
        status = curdf['status_true'].astype(int).astype(str).tolist()
